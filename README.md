...
Contest Extension (Context for short) is a Raspberry Pi-based amateur radio station management system intended for contesting. It is designed to be an extension of your radio and logger.
